...
class Simulate {
 public:
  ...
  mjuiDef defCmd[18] = {
    ...
    {mjITEM_SLIDERNUM,  "lin_vel_d,x", 1, &this->lin_vel_d[0], "-1.5 1.5"},
    {mjITEM_SLIDERNUM,  "lin_vel_d,y ", 1, &this->lin_vel_d[1], "-0.5 0.5"},
    ...
    {mjITEM_SLIDERNUM,  "ang_vel_d,y", 2, &this->ang_vel_d[2], "-1.5 1.5"},
